...
{
    /// <summary>
    /// Class to manage all of the queued processes that need to be run (for loading various kinds of files).
    /// </summary>
    class Runner
    {
    ...
    class SnapshotsProcess : Process
    {
        ...
        //public Int16 lastSnap = 3; //TODO, change back to 0
    ...
    class GlobalParameters
    {
            ...
            , string sqlCommansdsFile)
        {
            ...
            maxRandom = _maxRandom;
            random = new Random();
            summary = new LoaderSummary(LoaderParamSingleton.getInstance().server, LoaderParamSingleton.getInstance().database);
            summary.setBCPFile(sqlCommansdsFile);
